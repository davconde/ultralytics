...
def get_coco_from_labelme_folder(
    labelme_folder: str, coco_category_list: List = None, skip_labels: List[str] = [], **kwargs
) -> Coco:
    """
    Args:
    ...
    for json_path in tqdm(
        ...
        width = kwargs["args"].imageWidth if "imageWidth" not in data else data["imageWidth"]
        height = kwargs["args"].imageHeight if "imageHeight" not in data else data["imageHeight"]
        # init coco image
